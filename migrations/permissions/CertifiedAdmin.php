 ...
 */
class CertifiedAdmin extends BasePermission
{
    ...
    public function __construct($config = array())
    {
        ...
        $this->title = 'Certified Admin';
        $this->description = 'Admin personnel able to change the config state of the certified module.';
    }
